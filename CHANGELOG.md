...
### Security
- New and edited accounts save passwords in the native OS keychain. The wizard removes environment-variable checkboxes and offers a verified migration for legacy accounts. Linux requires Secret Service with no file or volatile fallback; see README for prerequisites and backup changes.
